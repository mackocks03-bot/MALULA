...
let startIdx = code.indexOf('export function AdminMessages()');
code = code.substring(0, startIdx);
if (!code.includes("import './css/AdminFinancials.css';")) {
    code = code.replace("import './css/AdminTasksMonitor.css';", "import './css/AdminTasksMonitor.css';\nimport './css/AdminFinancials.css';");
}
code = code + updated;

fs.writeFileSync(filepath, code);
console.log('Successfully styled AdminMessages!');
