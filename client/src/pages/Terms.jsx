...
const S = {
    wrap: { fontSize: 13, lineHeight: 1.8, color: 'var(--text-secondary)', maxWidth: 840, margin: '0 auto', paddingBottom: 60 },
    headerCard: {
        background: 'linear-gradient(135deg, rgba(229,184,74,0.1) 0%, rgba(229,184,74,0.02) 100%)',
        padding: '40px 24px',
        borderRadius: '24px',
        marginBottom: '24px',
    ...
    h1: { fontSize: 26, fontWeight: 800, color: 'var(--text-primary)', marginBottom: 12 },
    updated: { fontSize: 13, color: 'var(--text-muted)' },
    h2: { 
        fontSize: 16, 
        fontWeight: 700, 
        color: 'var(--color-gold)', 
        marginBottom: 16, 
        borderBottom: '1px solid rgba(229,184,74,0.1)', 
        paddingBottom: 12 
    },
    h3: { fontSize: 14, fontWeight: 600, color: 'var(--text-primary)', marginTop: 24, marginBottom: 8 },
    p: { marginBottom: 12 },
    ...
    footerStamp: { textAlign: 'center', color: 'var(--text-muted)', marginTop: 40, fontSize: 12 }
};
            ...
            <div className="dashboard-container" style={{ padding: 0 }}>
                <style>
                    ...
                    .terms-card:hover {
                        ...
                        border-color: rgba(229,184,74,0.2) !important;
                    }
                    `}
                </style>
                <div className="dashboard-content">
                    <div style={S.wrap}>
                        ...
                        <div style={{...S.highlight, background: 'rgba(229,184,74,0.06)', borderColor: 'rgba(229,184,74,0.15)'}}>
                        ...
                        {/* 1 */}
                        <div className="terms-card" style={S.card}>
                        ...
                        <div className="terms-card" style={{ ...S.highlight, background: 'rgba(16,185,129,0.06)', borderColor: 'rgba(16,185,129,0.2)', textAlign: 'center' }}>
